...
/* Does not compile on Sun Studio compiler -- disable on Sun systems */
/* Does not compile on CodeWarrior either -- disable on Metrowerks */
/* Does not run properly on iPhone -- disable on Apple -- starting to wonder the point.. */
#if !defined(__sun) && !defined(__MWERKS__) && !defined(__APPLE__)
